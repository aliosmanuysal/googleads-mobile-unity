  ...
  [GADInterstitialAd
   ...
   completionHandler:^(GADInterstitialAd *_Nullable interstitialAd,
    ...
    if (error || !interstitialAd) {
      if (strongSelf.adFailedCallback) {
        strongSelf.adFailedCallback(strongSelf.interstitialClient, (__bridge GADUTypeErrorRef)error);
      }
      return;
    }
    ...
    strongSelf.interstitialAd.paidEventHandler = ^void(GADAdValue *_Nonnull adValue) {
      ...
      if (strongSecondSelf.paidEventCallback) {
        ...
        strongSecondSelf.paidEventCallback(
                                           strongSecondSelf.interstitialClient, (int)adValue.precision,
